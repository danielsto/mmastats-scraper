...
def retrieve_data_leagues(mode, league_option):
    ...
    if status_code == 200:
        ...
        for i, r in enumerate(rows):
            ...
            pts_country, pts_team, pts_age = get_player_data(
                "pts_leader_name", r, season, mode
            )
            ...
            trb_country, trb_team, trb_age = get_player_data(
                "trb_leader_name", r, season, mode
            )
            ...
            ast_country, ast_team, ast_age = get_player_data(
                "ast_leader_name", r, season, mode
            )
            ...
            ws_country, ws_team, ws_age = get_player_data(
                "ws_leader_name", r, season, mode
            )
